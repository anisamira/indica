...
//START OF CHECK NOT EXISTS IN ISSUE

						$x=1;	
						$sql3="SELECT goal.*,strategy.*, actionplan.*, kpi.*, baseline.*, target.*, reference.*, form.*, achievement.*,year.*
						FROM goal 
                        ...
                        AND achievement.ach_desc < '$target'
