    ...
    ?>
        ...
        <div class="pure-controls">
                <label for="cb" class="pure-radio"><b>User Role</b></label>
                    <label> <input id="cb" type="radio" name="R01" value="R01"> Admin</label> <br> 
                    <label> <input id="cb" type="radio" name="R02" value="R02"> Data Manager</label> <br>
                    <label> <input id="cb" type="radio" name="R03" value="R03"> Data Controller</label> <br>
                    <label> <input id="cb" type="radio" name="R04" value="R04"> Deputy Vice Chancellor</label> <br>                    
        ...
        <div class="pure-controls">
                ...
                <div class="select" id="module">
                            ...
                            <select>
                            <option>Choose an option</option>
                            <option value="M01" name="M01">Module 1: Academic</option>
                            <option value="M02" name="M02">Module 2: Student Life</option>
                            <option value="M03" name="M03">Module 3: Excellent Research</option> 
                            <option value="M04" name="M04">Module 4: Internalization and Branding</option>
                            <option value="M05" name="M05">Module 5: Infrastructure Planning and Development</option>                    
                            <option value="M06" name="M06">Module 6: Financial Sustainability and Wealth Creation</option>
                            <option value="M07" name="M07">Module 7: Faculty and Staff Recruitment and Development</option>
                            </select>
                            </div>
                <!--  -->
