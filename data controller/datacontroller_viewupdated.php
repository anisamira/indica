	...
	<div class="wrapper">
			...
			<div class="header">
				<div class="topbar">
					<ul class="loginbar pull-right">
						<li>You are logged in as NUR ANIS AMIRAH <a href="#">( Logout )</a></li>
					</ul>
				</div>
			</div>
		</div>
		...
		<!--	<div class="table-responsive">  
			   <table class="table table-bordered"> 
					...
					<tr>  
						<td>1</td>
						<td rowspan="2">Vibrant campus living of the 21st Century</td>
						<td rowspan="2">Provide suitable accommodation for students</td>
